...
var objectMetadataColumns = []*plugin.Column{
...
func k8sCommonColumns(columns []*plugin.Column) []*plugin.Column {
	columns = append(columns, objectMetadataColumns...)
	columns = append(columns, typeMetaColumns...)
	columns = append(columns, specStatusColumns...)
